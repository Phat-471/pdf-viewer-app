...
<main class="site-main container">
	<header class="archive-header-banner">
		<div class="archive-banner-content">
			<h1 class="archive-title">Thương hiệu: <?php single_term_title(); ?></h1>
			<?php the_archive_description( '<div class="taxonomy-description">', '</div>' ); ?>
		</div>
		<div class="archive-banner-image">
			<img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/slide_smart_toilet.webp' ); ?>" alt="Thương hiệu sản phẩm">
		</div>
	</header>
